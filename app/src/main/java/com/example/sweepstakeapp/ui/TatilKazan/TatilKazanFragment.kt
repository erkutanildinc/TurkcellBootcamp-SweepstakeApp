package com.example.sweepstakeapp.ui.TatilKazan
...
class TatilKazanFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = TatilKazanFragment()
    }

    private lateinit var viewModel: TatilKazanViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(TatilKazanViewModel::class.java)
